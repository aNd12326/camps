  ...
  <div>
    <div class="page-header page-header-small">
      <parallax
        ...
        style="background-image: url('img/fotos/_MG_8305.jpg')"
      >
      </parallax>
      <div class="content-center">
        <div class="container">
          <h1 class="title">FM Camps</h1>
        ...
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            ...
            <h5 class="description">
              Permítanos apoyarlo en su servicio de FM con una plataforma moderna, rápida, flexible y amigable. Estamos una empresa nueva pero con profesionales de mucha experiencia. 
            </h5>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div
                ...
                style="background-image: url('img/fotos/CSUR 23_03-05-08 (26).jpg')"
              >
              ...
              <div
                ...
                style="background-image: url('img/fotos/P_20170818_063218.jpg')"
              ></div>
            </div>
            <div class="col-md-5">
              ...
              <div
                ...
                style="background-image: url('img/fotos/IMG_20180226_095316.jpg')"
              ></div>
              <h3>
    ...
    <div class="section section-contact-us text-center">
      <div class="container">
        ...
        <p class="description">TAWAYNASKP.</p>
        <div class="row">
